...
function uploadInvVTToShader(){
    gl.uniformMatrix3fv(shaderProgram.uInvVT, false, invVT);
}
...
function setupShaders() {
    ...
    shaderProgram.uInvVT = 
        gl.getUniformLocation(shaderProgram, "uInvVT");
...
function setupCubeMap() {
    ...
    var sources = [
        "skybox/pos-x.png", "skybox/neg-x.png", "skybox/pos-y.png", "skybox/neg-y.png", "skybox/pos-z.png", "skybox/neg-z.png"
    ];
    ...
    for (var i = 0; i < 6; i++)
    {
        ...
        {   
            ...
            if(ct == 6)
            {
                ...
                for (var j = 0; j < 6; j++)
                {
                    gl.texImage2D(cubemapTargets[j], 0, gl.RGBA,
                                  gl.RGBA, gl.UNSIGNED_BYTE, images[j]);
